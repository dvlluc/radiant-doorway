        ...
        <div className="flex items-center gap-2 md:gap-4">
          ...
          {showSearch ? (
            <form
              ...
              className="hidden md:flex items-center gap-2 animate-in fade-in slide-in-from-right-2 duration-200"
            >
              <Input
                type="text"
              ...
              <DropdownMenu>
                ...
                >
                  <div className="px-3 py-3 border-b">
                    <button
                      onClick={() =>
                        user && navigate(`/professional/${user.id}`)
                      }
                    ...
                    <p className="text-sm text-muted-foreground">
                      {profile?.account_type === "charitable_partner"
                        ? "Charity Partner"
