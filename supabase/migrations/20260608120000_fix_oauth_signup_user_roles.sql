-- OAuth users are confirmed on INSERT; defer user_roles to the client signup flow
-- so resolveOAuthSignupRedirect can distinguish new signups from existing accounts.
...
BEGIN
  ...
  IF should_process THEN
    ...
    -- Email confirmation path only; Google OAuth signup creates roles in the app.
